...
public class Delivery_Registration extends AppCompatActivity {
    ...
    String fname,lname,emailid,password,confpassword,mobile,house,Area,Pincode,statee;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getInstance().getReference("Delivery Person");
