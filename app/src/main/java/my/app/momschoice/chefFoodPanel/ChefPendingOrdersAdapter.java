...
//        View view = LayoutInflater.from(context).inflate(R.layout.activity_chef_orders, parent, false);
...
//        holder.grandtotalprice.setText("GrandTotal: Dhs " + chefPendingOrders1.getGrandTotalPrice());
...
public class ChefPendingOrdersAdapter extends RecyclerView.Adapter<ChefPendingOrdersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Vérifiez si chefPendingOrders1 n'est pas null avant d'accéder à ses méthodes
        if (chefPendingOrders1 != null) {
            holder.Address.setText(chefPendingOrders1.getAddress());
            holder.grandtotalprice.setText("GrandTotal: Dhs " + chefPendingOrders1.getGrandTotalPrice());
            final String random = chefPendingOrders1.getRandomUID();
            holder.Vieworder.setOnClickListener(new View.OnClickListener() {
            ...
            holder.Reject.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    handleRejectOrder(random);
                }
            });
        } else {
            Log.e("ChefPendingOrdersAdapter", "chefPendingOrders1 is null at position " + position);
        }
    }

    private void handleAcceptOrder(final String random) {
    ...
    private void handleOtherInformation(final String random) {
                ...
                if (chefPendingOrders1 != null) {
                    ...
                    FirebaseDatabase.getInstance().getReference("ChefPaymentOrders")
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    handleCustomerOrder(random);
                                }
                            });
                } else {
                    Log.e("ChefPendingOrdersAdapter", "chefPendingOrders1 (OtherInformation) is null for random UID " + random);
                }
            }
    ...
    private void handleCustomerOrder(final String random) {
        DatabaseReference Reference = FirebaseDatabase.getInstance().getReference("ChefPendingOrders")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .child(random)
                .child("Dishes");
        ...
        Reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                handleOtherInformationForCustomer(random);
            }
    ...
    private void handleOtherInformationForCustomer(final String random) {
                ...
                if (chefPendingOrders1 != null) {
                    ...
                    FirebaseDatabase.getInstance().getReference("CustomerPaymentOrders")
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    cleanUpPendingOrders(random);
                                }
                            });
                } else {
                    Log.e("ChefPendingOrdersAdapter", "chefPendingOrders1 (OtherInformation for customer) is null for random UID " + random);
                }
            }
    ...
    private void cleanUpPendingOrders(final String random) {
    ...
    private void handleRejectOrder(final String random) {
        DatabaseReference Reference = FirebaseDatabase.getInstance().getReference("ChefPendingOrders")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .child(random)
                .child("Dishes");
    ...
    private void cleanUpRejectedOrders(final String random) {
        FirebaseDatabase.getInstance().getReference("CustomerPendingOrders")
                .child(userid)
                .child(random)
                .child("Dishes")
